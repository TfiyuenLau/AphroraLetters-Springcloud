          ...
          <ul class="list-group rounded" v-if="category">
            ...
            <div>
              <li v-for="article in articleList" class="list-group-item"
                ...
                <div class="row">
                  <!-- 文章题图 -->
                  <div class="col-lg-3" style="max-height: 128px;padding-right: 0;">
                    <div style="cursor: pointer" @click="openArticle(article.id)">
                      <img style="height: 100%;width: 100%;object-fit: cover" :src="'/' + article.pictureUrl"
                           alt="文章题图"
                  ...
                  <div class="col-lg-9" style="position: relative;padding-left: 0;">
                    ...
                    <p class="h6 text-muted"
                       style="text-indent:1em;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;text-overflow: ellipsis;overflow: hidden;">
                      {{ article.summary }}
                    </p>
                    <br>
                    <!-- 发表时间 -->
