package team.aphroraletters.library.aop;
...
import team.aphroraletters.library.annotation.OperateLog;
import team.aphroraletters.library.util.RequestUtils;
...
public class OperateLogAspect {
     ...
     * 操作日志切入点
     */
    @Pointcut("@annotation(team.aphroraletters.library.annotation.OperateLog)")
    ...
    public void saveOperateLog(JoinPoint joinPoint, Object keys) {
        ...
        if (!"0:0:0:0:0:0:0:1".equals(requestIp) && !"127.0.0.1".equals(requestIp)) {
            ...
            try {
                ...
                String params = objectMapper.writeValueAsString(rtnMap);// 将参数所在的数组转换成json
