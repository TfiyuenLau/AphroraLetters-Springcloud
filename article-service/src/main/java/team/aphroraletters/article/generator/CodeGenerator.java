...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        DataSourceConfig.Builder dataSourceConfigBuilder = new DataSourceConfig
                .Builder(
                "jdbc:mysql://localhost:3306/aphrora_letters",
                "root",
                "123456");//内部会自行判断数据库类型
        ...
        String outputDir = projectPath + "/article-service" + "/src/main/java";
        ...
        packageConfigBuilder.parent("team.aphroraletters.article");//设置父包
...
//        strategyConfigBuilder.addInclude("version_log");
        strategyConfigBuilder.addInclude("admin");
